...
const ResizableContainer = ({ children }) => {
  ...
  return (
    <>
        <Resizable
            className='py-3 px-2 shadow-md flex flex-col justify-center items-center rounded-md bg-white my-8 dark:border-3p dark:border-solid dark:border-gray-50 dark:bg-blue-500 relative'
            // data-aos='fade-in'
            // data-aos-delay={300}
